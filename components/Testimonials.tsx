...
export default function Testimonials() {
  const images = [
    { src: 'https://picsum.photos/seed/bodybuilder1/600/400', alt: 'Transformação 1' },
    { src: 'https://picsum.photos/seed/fitness1/600/400', alt: 'Transformação 2' },
    { src: 'https://picsum.photos/seed/abs1/600/400', alt: 'Transformação 3' },
  ];
    ...
    <section id="testimonials" className="py-24 bg-zinc-900 text-zinc-100">
      <div className="container px-4 md:px-6 mx-auto">
        <div className="mb-16 text-center">
          ...
          >
            Veja como a dedicação e o acompanhamento profissional podem mudar vidas. Cada imagem conta uma história de superação e conquistas.
          </motion.p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-3 mb-16">
          {images.map((img, index) => (
            <motion.div
              ...
              className="relative aspect-[4/3] rounded-2xl overflow-hidden border border-zinc-800/50 group"
            >
              <Image
                src={img.src}
                alt={img.alt}
        ...
        >
          ...
          <div className="relative z-10 rounded-3xl bg-zinc-950 border border-zinc-800 p-8 md:p-12 text-center shadow-2xl">
            <p className="text-xl md:text-2xl font-medium text-zinc-300 leading-relaxed italic mb-6">
              &quot;Em X meses, alcancei resultados que nunca imaginei serem possíveis. O acompanhamento foi fundamental!&quot;
            </p>
            <div className="flex items-center justify-center space-x-4">
              <div className="h-1 w-12 bg-orange-500 rounded-full" />
              <p className="font-bold text-white uppercase tracking-wider text-sm">Cliente Satisfeito</p>
              <div className="h-1 w-12 bg-orange-500 rounded-full" />
            </div>
          </div>
        </motion.div>
