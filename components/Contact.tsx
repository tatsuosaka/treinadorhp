...
export default function Contact() {
  return (
    <section id="contact" className="py-24 bg-zinc-950 text-zinc-100 relative overflow-hidden">
      {/* Background Elements */}
          ...
          >
            <div>
              ...
              <p className="text-zinc-400 text-lg leading-relaxed">
                Estamos prontos para iniciar sua transformação. Agende sua consulta e descubra como podemos trabalhar juntos.
              </p>
            </div>
            ...
            <div className="grid gap-8 sm:grid-cols-2">
              <div className="space-y-4 p-6 rounded-2xl bg-zinc-900/50 border border-zinc-800 hover:border-orange-500/50 transition-colors">
                <div className="flex items-center space-x-3 text-orange-500">
                  ...
                  <h3 className="text-xl font-bold text-white">Agendamento</h3>
                </div>
                <p className="text-sm text-zinc-400">
                  Para consultas e detalhes sobre planos, entre em contato.
                </p>
                <div className="flex items-center space-x-2 text-zinc-300">
                  <Phone className="h-4 w-4 text-orange-500" />
                  <span className="font-medium">(19) XXXX-XXXX</span>
                </div>
              </div>
              ...
              <div className="space-y-4 p-6 rounded-2xl bg-zinc-900/50 border border-zinc-800 hover:border-orange-500/50 transition-colors">
                <div className="flex items-center space-x-3 text-orange-500">
                  ...
                  <h3 className="text-xl font-bold text-white">Siga-me</h3>
                </div>
                <p className="text-sm text-zinc-400">
                  Acompanhe meu trabalho e dicas nas redes sociais.
                </p>
                <a
            ...
            <div className="p-6 rounded-2xl bg-orange-500/10 border border-orange-500/20">
              <p className="text-orange-200 text-sm leading-relaxed">
                Aproveite nossa sessão experimental ou avaliação gratuita para conhecer de perto a metodologia.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="relative pl-6 before:absolute before:inset-y-0 before:left-0 before:w-1 before:bg-orange-500 before:rounded-full">
              <p className="text-2xl md:text-3xl font-medium text-white leading-tight italic">
                &quot;Seu corpo é seu templo — cuide dele com conhecimento, dedicação e paixão.&quot;
              </p>
            </div>
            
            <p className="text-zinc-400">
              Agradeço sua atenção! Estou à disposição para perguntas ou para agendar seu primeiro passo rumo à transformação.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              ...
              <a
                href="#about"
                className="inline-flex h-14 items-center justify-center rounded-xl border-2 border-orange-500 px-8 text-base font-bold text-orange-500 shadow-sm transition-all hover:bg-orange-500/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950"
              >
                Saiba Mais
              </a>
            </div>
