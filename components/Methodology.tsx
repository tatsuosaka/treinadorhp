        ...
        <section id="methodology" className="py-24 bg-zinc-900 text-zinc-100">
            <div className="container px-4 md:px-6 mx-auto">
                <div className="mb-16 text-center">
                    ...
                    >
                        Metodologia integra rigor científico com uma abordagem
                        altamente personalizada, garantindo resultados eficazes
                        e duradouros.
                    </motion.p>
                </div>
                ...
                <div className="mt-32">
                    ...
                    >
                        Resultados são a prova do compromisso com a excelência e
