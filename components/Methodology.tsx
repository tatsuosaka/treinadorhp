...
import { Search, Compass, FlaskConical, LineChart, Activity, CheckCircle, TrendingUp } from 'lucide-react';
  ...
  const steps = [
    {
      id: '01',
      title: 'Assess',
      description: 'Avaliação inicial detalhada para entender seu corpo, histórico e objetivos.',
      icon: <Search className="h-8 w-8" />,
    },
    {
      id: '02',
      title: 'Plan',
      description: 'Desenvolvimento de um plano personalizado baseado em evidências científicas.',
      icon: <Compass className="h-8 w-8" />,
    },
    {
      id: '03',
      title: 'Execute',
      description: 'Implementação do treinamento com acompanhamento e ajustes contínuos.',
      icon: <FlaskConical className="h-8 w-8" />,
    },
    {
      id: '04',
      title: 'Monitor',
      description: 'Monitoramento de progresso e resultados para garantir a eficácia do programa.',
  ...
  const results = [
    {
      ...
      description: 'Média em 6 meses com acompanhamento contínuo e personalizado.',
      icon: <TrendingUp className="h-6 w-6 text-orange-500" />,
    },
    {
      value: '80%',
      label: 'Redução de Dores',
      description: 'Melhora significativa nos quadros gerais de clientes com dores ou patologias.',
      icon: <Activity className="h-6 w-6 text-orange-500" />,
    },
    {
      value: '90%',
      label: 'Adesão ao Programa',
      description: 'Índices superiores, impulsionados pelo suporte motivacional e personalizado.',
    ...
    <section id="methodology" className="py-24 bg-zinc-900 text-zinc-100">
      <div className="container px-4 md:px-6 mx-auto">
        <div className="mb-16 text-center">
          ...
          >
            Nossa metodologia integra rigor científico com uma abordagem altamente personalizada, garantindo resultados eficazes e duradouros.
          </motion.p>
        </div>
        ...
        <div className="mt-32">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {results.map((result, index) => (
              ...
              >
                ...
                <h3 className="text-lg font-bold text-orange-500 mb-2">{result.label}</h3>
          ...
          >
            Nossos resultados são a prova do compromisso com a excelência e a eficácia de nossa metodologia.
          </motion.p>
        </div>
      </div>
    </section>
