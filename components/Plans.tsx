...
import { Calendar, Layers, Activity, Dumbbell, ShieldCheck, Zap, HeartHandshake, Clock } from 'lucide-react';
  ...
  const plans = [
    {
      ...
      description: 'Consultoria presencial e online, adaptada para atletas, praticantes de musculação e reabilitação.',
      icon: <Layers className="h-6 w-6" />,
    },
    {
      title: 'Períodos Variados',
      description: 'Planos mensais, trimestrais e semestrais, todos com acompanhamento individualizado e constante.',
      icon: <Calendar className="h-6 w-6" />,
    },
    {
      title: 'Serviços Completos',
      description: 'Avaliação inicial, prescrição de treino, orientações nutricionais básicas e suporte motivacional contínuo.',
      icon: <Activity className="h-6 w-6" />,
    },
    {
      title: 'Bodybuilding',
      description: 'Pacotes especiais para preparação de competições, com foco em performance e estética.',
  ...
  const differentials = [
    {
      ...
      description: 'Fisioterapia e treinamento físico juntos para resultados seguros e duradouros, prevenindo lesões e maximizando o desempenho.',
      icon: <ShieldCheck className="h-8 w-8 text-orange-500" />,
    },
    {
      title: 'Conhecimento Atualizado',
      description: 'Sempre à frente com as últimas pesquisas em hipertrofia, biomecânica e reabilitação, garantindo as melhores práticas.',
      icon: <Zap className="h-8 w-8 text-orange-500" />,
    },
    {
      title: 'Atendimento Humanizado',
      description: 'Foco no bem-estar físico e mental do aluno, construindo uma relação de confiança e respeito.',
      icon: <HeartHandshake className="h-8 w-8 text-orange-500" />,
    },
    {
      title: 'Flexibilidade Total',
      description: 'Planos adaptados para diferentes perfis, objetivos e rotinas, garantindo que o programa se encaixe perfeitamente em sua vida.',
